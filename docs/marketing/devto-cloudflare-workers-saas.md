...
The whole thing is open source (AGPL-3.0) and built by a solo developer. If you work with cron jobs and have opinions on what a monitoring tool should do, I'd genuinely love to hear them. Drop a comment below or open a [GitHub issue](https://github.com/nicepkg/cronpulse/issues).
